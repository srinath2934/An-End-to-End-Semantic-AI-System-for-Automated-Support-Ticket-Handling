...
This project builds on my semantic IT ticket routing research and expands it into an end-to-end AI engineering system. The original research focused on semantic routing using SBERT embeddings and F[...]

## Status

Ongoing development.

The goal is to move from research validation to a practical AI system that can classify support tickets, route them to the right team, estimate priority, and predict resolution effort from raw tic[...]
